...
namespace Tobii.Gaming.Examples.DynamicLightAdaptation
{
     ...
     * 2- Drag the profile "EyeAdaptationProfile.asset" to the profile public member of this component (Post Processing Profile). 
    ...
    public class DynamicLightAdaptation : MonoBehaviour
    {
        ...
        void Initialize()
        {
            ...
            {
                Debug.LogError(
                    "You must drag a profile to the post processing profile public member of DynamicLightAdaptation component");
            }
        }
